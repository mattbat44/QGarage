...
SETTINGS_PREFIX = "qgarage/"
MAX_HISTORY_ENTRIES = 20

logger = logging.getLogger("qgarage.settings")


def get_setting(key: str, default=None):
    """Read a QGarage setting from QGIS settings store."""
    return QgsSettings().value(SETTINGS_PREFIX + key, default)


def set_setting(key: str, value):
    """Write a QGarage setting to QGIS settings store."""
